...
Retain the exact old checkout, clone the annotated v0.4.3 release beside it,
...
then completes additive provisioning and repoints config to v0.4.3. A pending
