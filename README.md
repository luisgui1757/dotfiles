...
The published `v0.4.4` release path accepts only the exact clean official
annotated tag object `5c19cfaa19087b286d867c2bf422d33f76c64887`, which
peels to commit `05874e536372f6a73f8971c84e675e95666662d4` as recorded
...
Retain the exact old checkout, clone the annotated v0.4.4 release beside it,
...
then completes additive provisioning and repoints config to v0.4.4. A pending
...
from its retained exact release checkout before starting v0.4.4; the new setup
