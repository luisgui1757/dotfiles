...
--   parser      the nvim-treesitter parser for that filetype (false = none)
...
return {
  { fixture = "sample.lua", filetype = "lua", parser = "lua", formatters = { "stylua" }, lsp = "lua_ls" },
  {
    fixture = "sample.py",
    filetype = "python",
    parser = "python",
  ...
  { fixture = "sample.c", filetype = "c", parser = "c", formatters = { "clang_format" }, lsp = "clangd" },
  ...
  { fixture = "sample.md", filetype = "markdown", parser = "markdown", formatters = { "prettier" }, lsp = false },
  { fixture = "sample.vim", filetype = "vim", parser = "vim", formatters = {}, lsp = false },
  { fixture = "queries/lua/highlights.scm", filetype = "query", parser = "query", formatters = {}, lsp = false },
