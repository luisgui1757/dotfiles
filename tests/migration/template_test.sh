...
expected_for() {
    case "$1" in
        darwin)    printf '%s\n' ".config/ghostty" ".config/lazygit" ".psmux.conf" ".tmux.rose-pine.dawn.conf" ".tmux.rose-pine.main.conf" ".tmux.rose-pine.moon.conf" ".tmux.rose-pine.ps1" ".tmux.windows.conf" "AppData" "Documents" ;;
        linux)     printf '%s\n' ".psmux.conf" ".tmux.rose-pine.dawn.conf" ".tmux.rose-pine.main.conf" ".tmux.rose-pine.moon.conf" ".tmux.rose-pine.ps1" ".tmux.windows.conf" "AppData" "Documents" "Library" ;;
        linux-wsl) printf '%s\n' ".config/ghostty" ".psmux.conf" ".tmux.rose-pine.dawn.conf" ".tmux.rose-pine.main.conf" ".tmux.rose-pine.moon.conf" ".tmux.rose-pine.ps1" ".tmux.windows.conf" "AppData" "Documents" "Library" ;;
